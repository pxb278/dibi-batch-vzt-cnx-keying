...
dagId = "ENV-dibi-batch-" + appName + "-response-monitor"
...
# Task1 - Run Response File Monitor
t1= DataflowTemplateOperator(
    gcp_conn_id=dagConfig['gcpConnId'],
    task_id=appName + '-response-file-monitor',
    template=dagConfig['ResponseFileMonitor']['templateLocation'],
    job_name=appName + '-response-file-monitor',
    parameters={
        # DB Parameters
        ...
        # Job Parameters
        'outputPath': dagConfig['ResponseFileMonitor']['outputPath'],
        'emailFileName': dagConfig['ResponseFileMonitor']['emailFileName'],
