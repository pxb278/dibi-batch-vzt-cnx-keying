...
public interface LoadFromInactiveOvrerrideRecordsOptions extends GcpOptions, PGPCryptorOptions, HashiCorpVaultOptions,
		FileOutputOptions, JdbcIOOptions, JdbcExecutionOptions, FileInputOptions, VerizonHashiCorpVaultOptions {
	...
	@Description("DB Schema for CONNEXUSKEYOVERRIDE")
	@Validation.Required
	String getconnexusKeyOverrideDbSchema();

	void setconnexusKeyOverrideDbSchema(String value);
