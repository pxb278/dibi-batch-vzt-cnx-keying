...
public class TrailerFn<T> extends PTransform<PCollection<T>, PCollectionView<String>> {

	private static final long serialVersionUID = 1L;

	private ValueProvider<String> fileName;

	public TrailerFn(ValueProvider<String> fileName) {
		super();
