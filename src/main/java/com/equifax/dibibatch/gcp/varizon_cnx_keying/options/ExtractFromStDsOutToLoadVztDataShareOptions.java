...
public interface ExtractFromStDsOutToLoadVztDataShareOptions extends GcpOptions, PGPCryptorOptions,
		HashiCorpVaultOptions, FileInputOptions, JdbcIOOptions, JdbcExecutionOptions, BarricaderOptions {
	...
	@Description("ProcessName for this job")
	@Validation.Required
