...
public interface ExtractDivzcommsR00VztDsProdKrspOptions extends GcpOptions, PGPCryptorOptions, HashiCorpVaultOptions,
		FileOutputOptions, JdbcIOOptions, JdbcExecutionOptions, VerizonHashiCorpVaultOptions {

	@Description("DB Schema for VW_VZT_DATASHARE_CNX_RESP")
	@Validation.Required
	String getVwVztDataShareCnxRespDbSchema();

	void setVwVztDataShareCnxRespDbSchema(String value);
