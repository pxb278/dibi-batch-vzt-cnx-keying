...
public class ExtractFromStDsOutToLoadVztDataShareTransformTest {
	...
	public void validationTest() throws InvalidFieldException {
		...
		PCollectionTuple tupleTag = testPipeline
				...
				.apply("Barricade Encrypt", ParDo
						.of(new ExtractFromStDsOutToLoadVztDataShareTransform(validInputRecordsTag, invalidInputRecordsTag))
